# Smash Date — App UI Kit

A high-fidelity, interactive recreation of the **Smash Date** mobile PWA, built from the real `smash-date` codebase ( `github.com/subtlemocha00/smash-date` ). It mirrors the product's screens, component anatomy, copy, and the proposal **status machine** — with the brand palette and dark mode layered on per the design system.
